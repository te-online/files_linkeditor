...
test.describe("Link File Sharing", () => {
	test("open shared link file", async ({ page }) => {
		...
		await page.getByPlaceholder("Share with accounts and teams").click();
		await page.getByPlaceholder("Share with accounts and teams").fill("testuser");
		await page.getByRole("option", { name: "testuser-" }).click();
		await page.getByRole("button", { name: "Save share" }).click();
		await page.getByPlaceholder("Email, federated cloud id").press("Escape");
